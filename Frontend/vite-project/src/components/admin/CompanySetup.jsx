      ...
      <div className="max-w-3xl mx-auto my-10 bg-white shadow-lg rounded-lg p-8">
        <form onSubmit={submitHandler}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <Label className="font-medium text-gray-800">Company Name</Label>
              <Input
                type="text"
                name="name"
                value={input.name}
            ...
            <div className="sm:col-span-2">
              <Label className="font-medium text-gray-800">Logo</Label>
              <Input
                type="file"
                accept="image/*"
                onChange={changeFileHandler}
                className="mt-2 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200"
              />
            </div>
          </div>
          ...
          {loading ? (
            <Button
              className="w-full mt-8 flex justify-center items-center bg-[#4A90E2] text-white rounded-lg"
            >
